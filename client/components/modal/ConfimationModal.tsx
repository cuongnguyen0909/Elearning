...
const ConfirmationModal: React.FC<Props> = ({ open, title, setOpen, message, onConfirm }) => {
  ...
  return (
    ...
    >
      <Box className="absolute left-[50%] top-[50%] w-[450px] -translate-x-1/2 -translate-y-1/2 rounded-[8px] bg-white p-4 text-black shadow outline-none dark:bg-slate-900 dark:text-white">
