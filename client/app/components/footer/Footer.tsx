      ...
      <div className="mx-auto w-[95%] px-2 sm:px-6 800px:w-full 800px:max-w-[85%] lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-4">
              <li>
                <Link href={'/course'} className="text-base text-black dark:text-gray-300 dark:hover:text-white">
          ...
          <div>
            <h3 className="pb-3 text-[20px] font-[600] text-black dark:text-white">Liên hệ với chúng tôi</h3>
            <p className="pb-2 text-base text-black dark:text-gray-300 dark:hover:text-white">
              Địa chỉ: 180 Cao Lỗ, Phường 4, Quận 8, TP.HCM
            </p>
            {/* email */}
            <p className="pb-2 text-base text-black dark:text-gray-300 dark:hover:text-white">Email: edemy@edu.com</p>
