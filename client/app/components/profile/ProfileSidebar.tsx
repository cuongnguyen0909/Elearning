    ...
    return (
        <div className="w-full">
            ...
            >
                ...
                />
                <h5 className="hidden pl-2 font-Poppins text-black dark:text-white 800px:block">Thông tin cá nhân</h5>
            </div>
            <div
            ...
            >
                ...
                <h5 className="hidden pl-2 font-Poppins text-black dark:text-white 800px:block">Thay đổi mật khẩu</h5>
            </div>
            <div
            ...
            >
                ...
                <h5 className="hidden pl-2 font-Poppins text-black dark:text-white 800px:block">Khóa học của tôi</h5>
            </div>
            {isAdmin && (
                <Link className={`flex w-full cursor-pointer items-center px-3 py-4`} href={'/admin'}>
                    <MdOutlineAdminPanelSettings size={20} className="text-black dark:text-white" />
                    <h5 className="hidden pl-2 font-Poppins text-black dark:text-white 800px:block">Trang quản trị</h5>
                </Link>
            )}
            ...
            >
                ...
                <h5 className="hidden pl-2 font-Poppins text-black dark:text-white 800px:block">Đăng xuất</h5>
            </div>
        </div>
    );
};
