      ...
      <div className="m-auto min-h-screen w-[90%] py-5 pb-20 800px:w-[90%]">
        <div className="flex w-full flex-col-reverse 800px:flex-row">
          <div className="w-full pr-4 800px:w-[65%] 800px:pr-[5]">
            <h1 className="font-Poppins text-[26px] font-[600] text-black dark:text-white">{courseData?.title}</h1>
            ...
            <div>
              ...
              <br />
              <div>
                <h2 className="font-Poppins text-[22px] font-[600] text-black dark:text-white">Tổng quan khóa học</h2>
                <CourseContentList data={courseData} isDemo={true} />
              </div>
              <br />
              <br />
              <div className="w-full">
                <h1 className="font-Poppins text-[20px] font-[600] text-black dark:text-white">Mô tả khóa học</h1>
