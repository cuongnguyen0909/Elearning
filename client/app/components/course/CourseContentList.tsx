    ...
    return (
        <div className={`${!isDemo && 'sticky left-0 top-24 z-30 ml-[-30px]'} mt-[15px] w-full`}>
            {videoSections?.map((section: string, index: number) => {
                ...
                return (
                    <div
                        className={` ${!isDemo && 'border-b border-[#ffffff8e] pb-2'} className-section border border-[#ffffff0a] shadow-lg`}
                    >
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <h5 className="pl-8 text-black dark:text-white">
                                                {Number(item?.videoDuration) > 60
                                                    ? contentLength.toFixed(2)
                                                    : Number(item?.videoDuration)}{' '}
