                    ...
                    <div className="w-full rounded-sm shadow dark:bg-[#111C43]">
                        <div className="flex items-center justify-between p-4">
                            <div>
                                ...
                                <h5 className="pt-2 font-Poppins text-[20px] text-black dark:text-white">120</h5>
                                <h5 className="py-2 font-Poppins text-[20px] font-[400] text-black dark:text-white">
                                    Đã đăng ký
                                </h5>
                            </div>
                            <div>
                    ...
                    <div className="shadown my-6 w-full rounded-sm dark:bg-[#111C43]">
                        <div className="flex items-center justify-between p-4">
                            <div>
                                ...
                                <h5 className="pt-2 font-Poppins text-[20px] text-black dark:text-[#fff]">450</h5>
                                <h5 className="pt-2 font-Poppins text-[20px] font-[400] text-black dark:text-[#45CBA0]">
                                    Học viên mới
                                </h5>
                            </div>
                            <div>
