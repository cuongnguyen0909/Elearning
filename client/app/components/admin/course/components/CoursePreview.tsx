    ...
    <div className="m-auto mb-5 w-[90%] py-5 800px:w-[90%]">
      <div className="relative w-full">
        <div className="mt-10 w-full">
          ...
          <h1 className="font-Arimo text-[25px] font-[600]">{courseData?.title}</h1>
        </div>
        ...
        <div>
          ...
          <p className="pb-3 800px:pb-1">
            •{' '}
            <strong>
              Học theo lịch của bạn - học bất cứ khi nào, ở bất cứ đâu - trên máy tính bảng hoặc điện thoại
            </strong>
          </p>
        </div>
      </div>
      ...
      <div className="w-full">
        ...
        <br />
        {/* prerequisites  */}
        <h2 className="font-Arimo text-[25px] font-[600]">
        ...
        <div className="w-full">
          ...
          <p className="mt-[20px] w-full overflow-hidden whitespace-pre-line text-[18px]">{courseData?.description}</p>
        </div>
        <br />
        <br />
