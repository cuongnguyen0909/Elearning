    ...
    <div>
      <div className="w-full 1000px:flex">
        ...
        <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
          <h2 className="dark:text-white text-[#000000c7] text-[30px] px-3 w-full 1000px:text-[50px] font-[600] font-Josefin py-2 1100px:leading-[65px] 1500px:w-[90%] 1000px:ps-[80px] 1000px:mt-[150px]">
            Start your programming Journey with our Dedicated community!
          </h2>
          <h4 className="dark:text-white text-[#000000c7] text-[24px] px-3 w-full 1000px:text-[24px] font-[400] font-Josefin py-2 1100px:leading-[25px] 1500px:w-[90%] 1000px:ps-[80px]">
