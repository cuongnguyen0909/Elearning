...
const FAQ: FC<FAQProps> = (props) => {
    ...
    return (
        <div>
            <div className="p-24 text-center font-Poppins text-[25px] font-[700] leading-[35px] tracking-tight text-[#000] dark:text-white sm:text-3xl 800px:!leading-[60px] lg:text-4xl">
                ...
                <div className="mt-12">
                    <dl className="space-y-10">
                        {questions?.map((q: any, index: number) => (
                            <div
                                key={index}
                                className={`${q?._id !== questions[0]?._id && 'border-t pt-6'} border-gray-200`}
                            >
                                ...
                                {activeQuestion === q?._id && (
                                    <dd className="mt-2 pr-12">
                                        <p className="!text-start font-Poppins text-base font-normal text-black dark:text-white">
                                            {q?.answer}
                                        </p>
                                    </dd>
                                )}
