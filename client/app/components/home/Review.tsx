...
const Review: FC<ReviewProps> = (props) => {
    ...
    return (
        <div className="m-auto mt-20 w-[30%] pt-6 800px:w-[85%]">
            <div className="w-full items-center gap-10 800px:flex">
                ...
                <div className="w-full 800px:w-[50%]">
                    <h3 className={`${styles.title} 800px:!text-[40px]`}>Đánh giá từ học viên</h3>
                    <br />
                    <p className={styles.label}>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore, placeat totam reprehenderit
                        soluta nostrum labore deserunt eligendi ratione consequuntur nesciunt!
                    </p>
                </div>
                <br />
                <br />
